...
HUD::HUD(sf::RenderWindow& ventana) : ventana(ventana) {
    ...
    textoTurno = crearTexto("Turno: JUGADOR 1", 24, sf::Color(128, 192, 64), 0, 0);
    {
...
void HUD::construirFilas() {
    ...
    DefColor defsJ1[4] = {
        {sf::Color(48, 112, 192), sf::Color(160, 192, 255)},  // AZL1
        {sf::Color(48, 112, 192), sf::Color(160, 192, 255)},  // AZL2
        {sf::Color(192, 48,  48), sf::Color(255, 144, 144)},  // ROJ1
        {sf::Color(192, 48,  48), sf::Color(255, 144, 144)}   // ROJ2
    };
    DefColor defsJ2[4] = {
        {sf::Color(48, 160, 48),  sf::Color(144, 255, 144)},  // VRD1
        {sf::Color(48, 160, 48),  sf::Color(144, 255, 144)},  // VRD2
        {sf::Color(176, 144, 32), sf::Color(255, 224, 128)},  // AMR1
        {sf::Color(176, 144, 32), sf::Color(255, 224, 128)}   // AMR2
    };
...
void HUD::actualizarFila(FilaTanque& fila, const DatosTanque& datos) {
    ...
    if (pct > 0.5f)
        fila.barraVida.setFillColor(fila.barraVida.getFillColor());
    else if (pct > 0.25f)
